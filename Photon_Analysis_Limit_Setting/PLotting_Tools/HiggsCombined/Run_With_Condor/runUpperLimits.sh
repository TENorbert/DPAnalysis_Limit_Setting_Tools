...
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood  --fork 4 -m $datacard >>$Outputfile 
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood --expectedFromGrid 0.025 --fork 4 -m $ctau -n $datacard >>$Outputfile 
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood --expectedFromGrid 0.16 --fork 4 -m $ctau -n $datacard >>$Outputfile 
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood --expectedFromGrid 0.5 --fork 4 -m $ctau -n $datacard >>$Outputfile 
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood --expectedFromGrid 0.84 --fork 4 -m $ctau -n $datacard >>$Outputfile 
#combine -M HybridNew -t100 -S0 --frequentist --testStat LHC $datacard -H ProfileLikelihood --expectedFromGrid 0.98 --fork 4 -m $ctau -n $datacard >>$Outputfile 
